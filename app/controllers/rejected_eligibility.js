...
angular.module('myApp.rejectedEligibility', ['ngRoute']);

app.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/rejectedEligibility', {
        templateUrl: 'transactions/rejected_eligibility.html',
        controller: 'rejected_eligibility_Ctrl',
        resolve:
            {
...
app.controller('rejected_eligibility_Ctrl', ['$scope', '$rootScope', '$sessionStorage', '$http', '$timeout', '$route', '$filter', 'updateStatus_factory',
