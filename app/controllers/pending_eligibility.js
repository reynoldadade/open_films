...
angular.module('myApp.pendingEligibility', ['ngRoute']);

app.config(['$routeProvider', function($routeProvider) {
    $routeProvider .when('/pendingEligibility', {
        templateUrl: 'transactions/pending_eligibility.html',
        controller: 'pending_eligibility_Ctrl',
        resolve:
            {
...
app.controller('pending_eligibility_Ctrl',['$scope','$rootScope','$sessionStorage','$http','$timeout','$route','$filter','updateStatus_factory',
